...
## divide panel into 2x2 matrix
par(mfrow=c(2,2))

## create first plot
plot(dt, df$Global_active_power, ylab='Global Active Power', xlab='', type='l')

## create second plot
plot(dt, df$Voltage, xlab='datetime', ylab='Voltage', type='l')
...
## create fourth plot
plot(dt, df$Global_reactive_power,
